...
def print_result():
    ...
    if gr.start_time:  # make this check to see if the user has entered start_time
        now = datetime.datetime.now()
        current_time = datetime.datetime.timestamp(now)
        elapsed_time = current_time - gr.start_time
